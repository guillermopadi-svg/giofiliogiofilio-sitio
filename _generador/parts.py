    ...
    <div class="map-col" aria-label="Mapa de propiedades">
      <div id="map" style="height:100%">
        ...
        <div class="map-filters">
          <div class="seg seg--sm" data-f-seg="operacion">
            <button type="button" data-v="" aria-pressed="true">Todas</button>
            <button type="button" data-v="venta" aria-pressed="false">Venta</button>
            <button type="button" data-v="renta" aria-pressed="false">Renta</button>
          </div>
          <select data-f-select="tipo" aria-label="Filtrar por tipo de inmueble" class="map-filters-select">
            <option value="">Tipo</option><option value="departamento">Departamento</option><option value="casa">Casa</option><option value="casa-en-condominio">Casa en condominio</option><option value="penthouse">Penthouse</option><option value="loft">Loft</option><option value="terreno">Terreno</option><option value="oficina">Oficina</option><option value="local-comercial">Local comercial</option><option value="desarrollo">Desarrollo</option>
          </select>
          <div class="map-filters-precio">
