...
dict(id="GF-1024", titulo="Departamento con terraza y vista a Chapultepec",
...
dict(id="GF-1031", titulo="Penthouse con roof privado",
...
dict(id="GF-1042", titulo="Departamento amueblado en renta",
...
dict(id="GF-1055", titulo="Departamento de gran formato remodelado",
...
dict(id="GF-1068", titulo="Casa con jardín maduro",
...
dict(id="GF-1073", titulo="Casa para remodelar",
...
dict(id="GF-1081", titulo="Casa en renta con alberca",
...
dict(id="GF-1096", titulo="Departamento remodelado",
...
dict(id="GF-1104", titulo="Departamento nuevo con roof garden",
...
dict(id="GF-1112", titulo="Casa con vista a barranca",
...
dict(id="GF-1125", titulo="Departamento en edificio restaurado",
...
dict(id="GF-1133", titulo="Loft con doble altura",
...
dict(id="GF-1147", titulo="Departamento de inversión",
...
dict(id="GF-1158", titulo="Departamento art déco frente al Parque México",
...
dict(id="GF-1166", titulo="Departamento en renta con terraza",
...
dict(id="GF-1174", titulo="Departamento con vista al parque",
...
dict(id="GF-1189", titulo="Departamento nuevo sobre corredor Reforma",
...
dict(id="GF-1195", titulo="Oficina sobre Paseo de la Reforma",
...
dict(id="GF-1208", titulo="Departamento familiar",
...
dict(id="GF-1224", titulo="Departamento amplio con tres recámaras",
...
dict(id="GF-1237", titulo="Departamento en renta cerca del Parque Delta",
...
dict(id="GF-1245", titulo="Departamento junto al Parque Hundido",
...
dict(id="GF-1253", titulo="Departamento de entrada",
...
dict(id="GF-1261", titulo="Departamento nuevo de entrega inmediata",
...
dict(id="GF-1274", titulo="Local comercial a pie de avenida",
...
# ======================================= SANTA FE (Cuajimalpa)
dict(id="GF-1288", titulo="Departamento con amenidades completas",
...
dict(id="GF-1296", titulo="Departamento en renta con vista al parque",
...
dict(id="GF-1305", titulo="Casa colonial con jardín",
...
dict(id="GF-1313", titulo="Casa de autor",
...
dict(id="GF-1327", titulo="Casa con jardín en calle arbolada",
...
dict(id="GF-1334", titulo="Casa en condominio con seguridad privada",
...
dict(id="GF-1348", titulo="Desarrollo en preventa — 24 unidades",
...
dict(id="GF-1356", titulo="Departamento de inversión con renta vigente",
...
dict(id="GF-1362", titulo="Terreno con uso de suelo habitacional",
...
dict(id="GF-1371", titulo="Departamento con home office",
...
dict(id="GF-1394", titulo="Casa en condominio con roof garden",
